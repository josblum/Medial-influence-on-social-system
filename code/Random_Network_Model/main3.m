...
mean_nbr_of_friends_per_agent(1,1)=8;           %Mean number of close friends per agent (even number!)
mean_nbr_of_friends_per_agent(2,1)=20;           %Mean number of FB-friends per agent (even number!)
